...
public class GamePlayActivity extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    Context ctx;
    ImageView imgVw ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        draw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(GamePlayActivity.this, "There is no need to draw a card", Toast.LENGTH_LONG).show();
            }
        });
        ...
        sayUno.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(GamePlayActivity.this, "Are you sure you can say UNO?", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    finishTurn.setOnClickListener(new View.OnClickListener(){
                        public void onClick(View v){
                           ...
                           // SystemClock.sleep(1000);
                            Intent openIntent = new Intent(GamePlayActivity.this, FourthAct.class);
