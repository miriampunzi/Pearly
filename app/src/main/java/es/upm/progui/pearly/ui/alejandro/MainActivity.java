       ...
       Button draw = findViewById(R.id.button4);
        ...
        draw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(MainActivity.this, "There is no need to draw a card", Toast.LENGTH_LONG).show();
        ...
        sayUno.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                    ...
                    Toast.makeText(MainActivity.this, "Are you sure you can say UNO?", Toast.LENGTH_SHORT).show();
                ...
                if (event.getResult()) {
                    ...
                    finishTurn.setOnClickListener(new View.OnClickListener(){
                        public void onClick(View v){
                            ...
                            Intent openIntent = new Intent(MainActivity.this, FourthAct.class);
