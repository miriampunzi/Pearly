...
public class FourthAct extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    Context ctx;
    ImageView imgVw ;
    ImageView im1;
    ImageView im2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* TextView txtVw = (TextView) findViewById(R.id.lbl);
        ...
        sayUno = (Button) findViewById(R.id.button5);
        ...
        imgVw = (ImageView) findViewById(R.id.imageView5);
        ...
        draw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(FourthAct.this, "There is no need to draw a card", Toast.LENGTH_LONG).show();
        ...
        sayUno.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                //Toast.makeText(this,"UNO",500).show();
                if(unoFlag == 1){
                    //Toast.makeText(this,getString(R.string.uno),Toast.LENGTH_SHORT).show();
                    Toast.makeText(FourthAct.this, "UNO", Toast.LENGTH_LONG).show();

                }else{
                    Toast.makeText(FourthAct.this, "Are you sure you can say UNO?", Toast.LENGTH_SHORT).show();
                   ...
                   // SystemClock.sleep(1500);
                    ...
                    finishTurn.setOnClickListener(new View.OnClickListener(){
                        public void onClick(View v){
                            ...
                            Intent openIntent = new Intent(FourthAct.this, SixthAct.class);
