...
public class SixthAct extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    Context ctx;
    //ImageView imgVw ;
    ImageView im1;
    //ImageView im2;
...
//        im2.setOnLongClickListener(this);
        ...
        draw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(SixthAct.this, "There is no need to draw a card", Toast.LENGTH_LONG).show();
        ...
        sayUno.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(SixthAct.this, "Are you sure you can say UNO?", Toast.LENGTH_SHORT).show();
                ...
                if (event.getResult()) {
                    ...
                    finishTurn.setOnClickListener(new View.OnClickListener(){
                        public void onClick(View v){
                            ...
                            Intent openIntent = new Intent(SixthAct.this, WinAct.class);
