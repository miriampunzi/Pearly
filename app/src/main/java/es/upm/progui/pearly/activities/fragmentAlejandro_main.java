...
public class fragmentAlejandro_main extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    Context ctx;
    ImageView imgVw ;
    ImageView im1;
    ImageView im2;
       ...
       Button draw = findViewById(R.id.button4);
        ...
        draw.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                Toast.makeText(fragmentAlejandro_main.this, "There is no need to draw a card", Toast.LENGTH_LONG).show();
        ...
        sayUno.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                    ...
                    Toast.makeText(fragmentAlejandro_main.this, "Are you sure you can say UNO?", Toast.LENGTH_SHORT).show();
                ...
                if (event.getResult()) {
                    ...
                    finishTurn.setOnClickListener(new View.OnClickListener(){
                        public void onClick(View v){
                            ...
                            Intent openIntent = new Intent(fragmentAlejandro_main.this, fragment_Alejandro2.class);
